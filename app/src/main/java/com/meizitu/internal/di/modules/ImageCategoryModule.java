 ...
 */
@Module
public class ImageCategoryModule {

    private int categoryParentId = -1;

    public ImageCategoryModule() {
    }

    public ImageCategoryModule(int categoryParentId) {
    ...
    EasyWorkUseCase.RequestValues provideGetCategoryListRequestValues(ImageApi imageApi) {
        EasyCall easyCall = new RetrofitCallToEasyCall<>(imageApi.categoryList(categoryParentId));
