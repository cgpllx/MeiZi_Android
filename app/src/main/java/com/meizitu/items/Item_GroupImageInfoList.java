...
public class Item_GroupImageInfoList extends GroupImageInfo implements IFlexible<Item_GroupImageInfoList.ViewHolder> {
    ...
    @Override
    public Item_GroupImageInfoList.ViewHolder createViewHolder(EasyFlexibleAdapter adapter, LayoutInflater inflater, ViewGroup parent) {
        return new ViewHolder(inflater.inflate(getLayoutRes(), parent, false), adapter);
    }

    @Override
    public void bindViewHolder(EasyFlexibleAdapter adapter, Item_GroupImageInfoList.ViewHolder holder, int position, List payloads) {
        holder.setData(this);
    }
    ...
    public class ViewHolder extends FlexibleViewHolder {
        ...
        //-------------------
        public void setData(GroupImageInfo imageInfo) {
        ...
        void setImageDefaultLayoutParams() {
            ViewGroup.LayoutParams layoutParams = image.getLayoutParams();
            layoutParams.height = DisplayUtils.dp2Px(getContext(), 400);
            image.setLayoutParams(layoutParams);
        }
